...
class TBDTest(StaticLiveServerTestCase):
    ...
    def test_project_form(self):
        ...
        self.browser.find_element_by_css_selector("#id_project_table tr td a span.glyphicon-remove").click()
        project_table = self.browser.find_element_by_id('id_project_table')
        rows = project_table.find_elements_by_tag_name('tr')
    ...
    def test_build_form(self):
        ...
        build_table = self.browser.find_element_by_id('id_build_table')
        rows = build_table.find_elements_by_tag_name('tr')
        self.assertEqual(len(rows), 1)
        ...
        self.browser.find_element_by_css_selector("#id_build_table tr td a span.glyphicon-remove").click()
        build_table = self.browser.find_element_by_id('id_build_table')
        rows = build_table.find_elements_by_tag_name('tr')
        self.assertEqual(len(rows), 1)